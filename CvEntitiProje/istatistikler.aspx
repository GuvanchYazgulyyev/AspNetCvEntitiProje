<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="istatistikler.aspx.cs" Inherits="CvEntitiProje.istatistikler" %>
...
<div class="total-world">
    ...
    <div class="site-report">
        ...
        <p>Entiti CV  projemizin admin paneli kısmındasınız. Umaraım size faydalı bir kurs olmuştur.</p>
    </div>
    <div class="clearfix"></div>
</div>
